...
public partial class CalculoIMC : Window
{
    ...
    private void Calcular_Click(object sender, RoutedEventArgs e)
    {
        ...
        if (alturaM > 3m) alturaM /= 100m; // aceita cm
        ...
        // Thresholds baseados em NHANES 1976/1980
        decimal bmiMagro, bmiMedia, bmiSobrepeso, bmiGordo, bmiObeso;
        if (isHomem)
        { bmiMagro = 20.70m; bmiMedia = 23.55m; bmiSobrepeso = 26.40m; bmiGordo = 27.80m; bmiObeso = 31.10m; }
        else
        { bmiMagro = 18.50m; bmiMedia = 21.70m; bmiSobrepeso = 24.90m; bmiGordo = 29.90m; bmiObeso = 34.90m; }
